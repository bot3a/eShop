...
const PaymentController = {
  ...
  //     console.log("Cart Items only:", cartItems);
  //     console.log("Address:", shippingAddress);
  //   }

  //   if (!cartItems || cartItems.length === 0) {
  //     return next(new AppError("Cart is empty form here", 404));
  //   }

  //   if (!shippingAddress) {
  //     return next(new AppError("Address is required", 404));
  //   }
  ...
  //   }
  //   console.log(shippingAddress.id);
  ...
  //     optionalRemarks: shippingAddress.optional_remarks ?? "",
  //   };
  ...
  //       shippingAddress: shippingAddress.id.toString(),
